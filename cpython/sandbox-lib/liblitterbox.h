...
extern void SB_Initialize();

extern void SB_Prolog(char* p0);
...
extern void SB_RegisterSandbox(int p0, char* p1, char* p2, char* p3);

extern int SB_GetSandboxPid(char* p0);
